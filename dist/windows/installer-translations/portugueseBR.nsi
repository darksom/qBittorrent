...
LangString inst_uninstall_question ${LANG_PORTUGUESEBR} "Uma instação anterior foi detectada. Ela será desinstalada sem deletar as configurações de usuário."
